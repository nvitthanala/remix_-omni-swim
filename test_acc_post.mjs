...
async function test() {
  const file1 = fs.readFileSync('2026_acc_championship_full_meet_results_1col.pdf').toString('base64');
  ...
  try {
    ...
    console.log(`ACC length: ${data.results.length}`);
    console.log('ACC Teams:', Array.from(teams));
