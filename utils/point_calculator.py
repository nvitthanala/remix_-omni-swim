...
def _resolve_scoring_settings(scoring_settings=None):
    # Default: conference meet scoring (all A/B finalists score, no team caps)
    # This matches how actual conference championship meets work.
    # Team caps (maxIndividuals/maxRelays) are only for NCAA allocation limits.
    if not scoring_settings:
        return {
            ...
            'maxRelaysScoringPerTeam': 999,       # No cap for conference scoring
            'maxRosterSize': 99
        }
